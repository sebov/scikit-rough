...
from skrough.checks import (
    ...
    check_functional_dependency_slower,
)
...
def test_checks_functional_dependency_slower(
    objs, attrs, expected_result, golf_dataset_prep
):
    x, _, y, _ = golf_dataset_prep
    assert check_functional_dependency_slower(x, y, objs, attrs) == expected_result
