...
class RoughBase(sklearn.base.BaseEstimator):
    ...
    def fit(self, x, y, sample_weight=None, check_data_consistency=False):
        ...
        if check_data_consistency:
            # TODO: by default check_data_consistency should be True but for now we do not handle this
...
# ReductBase = collections.namedtuple('Reduct', [ATTRIBUTES_FIELD])
# BireductBase = collections.namedtuple('Bireduct', [OBJECTS_FIELD, ATTRIBUTES_FIELD])
