...
class SamplingHeuristicBireduct(RoughBase, DecTableOpsMixin):
    ...
    def __init__(self, epsilon=0.0, candidate_n_attrs=None, max_n_attrs=None,
        ...
        super(SamplingHeuristicBireduct, self).__init__(score_func, random_state=random_state)
    ...
    def get_bireduct(self):
        ...
        while True:
            ...
            current_chaos_score = self.compute_chaos_score(group_index, n_groups, xx, yy, yy_count_distinct)
            ...
            if self.candidate_n_attrs is not None:
                ...
                candidate_attrs = np.random.choice(candidate_attrs,
                                                   ...
                                                   replace=False)
            best_attr = self.get_best_attr(group_index, n_groups, candidate_attrs, xx, xx_count_distinct, yy, yy_count_distinct)
