...
Progress, decisions, and pending items for each source ingestion. This file also contains
general guidelines for how to extract knowledge from sources.

---

## General Guidelines for Knowledge Extraction

These guidelines apply to all source ingestion and proof construction. They emerged from
practical experience and should be followed by all agents working with the knowledge base.
