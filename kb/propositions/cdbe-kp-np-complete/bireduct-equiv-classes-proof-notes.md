...
## Status
- **Krok 1**: Zapisany w TeX (`prop:bireduct_equiv_classes_geq_bplus1`)
- **Kroki 2-4**: Do zapisania w TeX
- **Ten plik**: Do skasowania po przeniesieniu dowodu do KB
...
## Następne kroki
1. Dokończyć zapis kroków 2-4 w TeX
2. Przenieść `prop-bireduct-equiv-classes-geq-bplus1` z staging/ do głównego katalogu propositions/
