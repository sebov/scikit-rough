...
#     result = list(result.sample(len(result), weights=weights,
...
#         super(OrderingHeuristicBireduct, self).__init__(score_func,
# random_state=random_state)
...
#         result_attrs = []
#         result_objects = []
#         # permutation = generate_permutation(self.x.shape[0], self.x.shape[1],
# random_state=random_state)
