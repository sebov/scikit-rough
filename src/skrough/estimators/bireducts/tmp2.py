...
# # reduction phase
# before_reduction_chaos_score = self.compute_chaos_score(
#     group_index, n_groups, xx, yy, yy_count_distinct
# )
...
#     xx[:, result_attrs].T, xx_count_distinct[result_attrs], sort=False, xnull=False
# )
